(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-array'), require('d3-scale'), require('d3-time'), require('d3-random'), require('d3-request'), require('d3-path'), require('d3-selection'), require('d3-shape'), require('d3-dispatch'), require('d3-brush')) :
  typeof define === 'function' && define.amd ? define(['exports', 'd3-array', 'd3-scale', 'd3-time', 'd3-random', 'd3-request', 'd3-path', 'd3-selection', 'd3-shape', 'd3-dispatch', 'd3-brush'], factory) :
...
}(this, (function (exports,d3Array,d3Scale,d3Time,d3Random,d3Request,d3Path,d3Selection,d3Shape,d3Dispatch,d3Brush) { 'use strict';
    ...
    var autoBandwidth = function autoBandwidth(arg) {
        ...
        var computeWidth = function computeWidth(data) {
            ...
            if (crossScale.bandwidth) {
                ...
                var crossValuePoints = flattenedData.filter(adaptee.defined).map(adaptee.crossValue()).map(crossScale);
...
var xyBase$2 = (function () {
    ...
    base.defined = function (d, i) {
        return defined$2(baseValue, crossValue, mainValue)(d, i);
    };
    ...
    base.baseValue = function () {
        ...
        baseValue = functor$7(arguments.length <= 0 ? undefined : arguments[0]);
        return base;
    };
    base.crossValue = function () {
        if (!arguments.length) {
        ...
        crossValue = functor$7(arguments.length <= 0 ? undefined : arguments[0]);
        return base;
    };
    base.mainValue = function () {
        if (!arguments.length) {
        ...
        mainValue = functor$7(arguments.length <= 0 ? undefined : arguments[0]);
        return base;
    };
    base.barWidth = function () {
        if (!arguments.length) {
        ...
        barWidth = functor$7(arguments.length <= 0 ? undefined : arguments[0]);
        return base;
    };
    base.orient = function () {
        if (!arguments.length) {
...
var line$5 = (function () {
    ...
    var line$$1 = function line$$1(selection$$1) {
        ...
        selection$$1.each(function (data, index, group) {
            var path$$1 = join(d3Selection.select(group[index]), [data]);
            path$$1.attr('d', lineData).attr('fill', 'none').attr('stroke', colors$2.black);
            base.decorate()(path$$1, data, index);
        });
    };
...
var line$6 = (function () {
    ...
    var line$$1 = function line$$1(data) {
        ...
        context.beginPath();
        lineData(data);
        context.strokeStyle = colors$2.black;
...
var errorBarBase$2 = (function () {
    ...
    base.defined = function (d, i) {
        return defined$2(lowValue, highValue, crossValue)(d, i);
    };
    ...
    base.lowValue = function () {
        ...
        lowValue = functor$7(arguments.length <= 0 ? undefined : arguments[0]);
        return base;
    };
    base.highValue = function () {
        if (!arguments.length) {
        ...
        highValue = functor$7(arguments.length <= 0 ? undefined : arguments[0]);
        return base;
    };
    base.crossValue = function () {
        if (!arguments.length) {
...
var ohlcBase$7 = (function () {
    ...
    base.defined = function (d, i) {
        return defined$2(crossValue, openValue, lowValue, highValue, closeValue)(d, i);
    };
...
var boxPlotBase$2 = (function () {
    ...
    base.defined = function (d, i) {
        return defined$2(lowValue, highValue, lowerQuartileValue, upperQuartileValue, crossValue, medianValue)(d, i);
    };
    ...
    base.lowerQuartileValue = function () {
        ...
        lowerQuartileValue = functor$7(arguments.length <= 0 ? undefined : arguments[0]);
        return base;
    };
    base.upperQuartileValue = function () {
        if (!arguments.length) {
        ...
        upperQuartileValue = functor$7(arguments.length <= 0 ? undefined : arguments[0]);
        return base;
    };
    base.lowValue = function () {
        if (!arguments.length) {
    ...
    base.medianValue = function () {
        ...
        medianValue = functor$7(arguments.length <= 0 ? undefined : arguments[0]);
        return base;
    };
    base.barWidth = function () {
        if (!arguments.length) {
